...
const IT_TO_EN_TEXT_REPLACEMENTS: Record<string, string> = {
  ...
  'A Roma fai come i Romani': 'Roma Da Romano',
  'Roma tour mangia prega ama': 'Roma Mangia Prega Ama',
  ...
  'Conferma immediata per ambiente test.': 'Immediate confirmation for test environment.',
  ...
  'La tua segnalazione e stata registrata. Ora contattaci subito per completare obbligatoriamente gli ultimi dettagli.': 'Your payment notice has been recorded. Contact us now to complete the final mandatory details.',
  'Contatto obbligatorio per ultimi dettagli': 'Mandatory contact for final details',
  'Contattaci subito tramite uno dei canali seguenti per gli ultimi dettagli.': 'Contact us immediately through one of the channels below for the final details.',
  ...
  'Totale Prenotazione': 'Booking Total',
  'In attesa verifica': 'Awaiting verification',
  ...
  'Metodo di pagamento non supportato.': 'Unsupported payment method.',
